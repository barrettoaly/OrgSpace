...
<div class="container py-5">
	  <div class="row">
            ...
            <button class="arrow left"> <a href ="applyfororganizations.php">
            ...
            <div class= "col-md-5 ">               
                ...
                <p  style ="text-align:Center; font-family:Enriqueta,arial,serif; line-height: 1.25; margin: 0 0 10px; font-size: 18px; font-weight: normal; color: #848484;"> <?php echo $row['Position'];?> </p>
                 <p style ="text-align:Center; font-family:Enriqueta,arial,serif; line-height: 1.25; margin: 0 0 10px; font-size: 15px; font-weight: bold; color: black;"> Available Position/s </p>      
                 
                        
                <a href="applyform.php?id=<?php echo $row['recruitment_ID'] ?>&amp;oid=<?php echo $row['OrgID']?>&amp;p=<?php echo $row['Position']?>"  role="button" style="position: absolute;right:0; bottom:0;" class="align-self-end btn btn-secondary btn-block">Apply Organization</a>
                </div>
