...
svg { padding: 5px;}
.arrow {cursor: pointer;position: absolute;top: 50%;margin-top: -25px;margin-left: -60px;width: 40px;height: 40px;}
.left {left: 5%;}
  ...
  transform: translate(-50%, -50%);
	...
	<body data-spy="scroll" data-target=".navbar" data-offset="50">
		...
		<nav class="navbar navbar-expand-lg fixed-top">
			<div class="container">
				<a class="navbar-brand" href="index.php"><img src="OrgSpace_LOGO_Final_White.png" style="width:50px; height: 50px;" alt="OrgSpace">Join Organizations</a>
        ...
        <div class = "container  py-5">
                ...
                <button class="arrow left"> <a href ="index.php">
                        ...
                        while ($row = mysqli_fetch_array($query))
                        {
                            ...
                            <img src = "officer_dashboard/orgpic/<?php echo $row['Org_Pic']; ?>" width="256px" height="200px" alt= "Org Picture">
                                <div class = "card-body text-center d-flex flex-column"  >
                                    ...
                                    <a href="viewdetailsout.php?id=<?php echo $row['recruitment_ID'] ?>" role="button" style="margin-top: auto;" class="align-self-end btn btn-secondary btn-block">View Details</a>
                                </div>
                            </div>
