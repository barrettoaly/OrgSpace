								...
								<div class="d-sm-flex justify-content-between">
									<div data-aos="zoom-in-up">
										<div class="banner-title">
											<h4 class="font-weight-medium"> Hello, <?php session_start(); echo $_SESSION['username']; $orgid= $_SESSION['orgid'];?>   </h4>
					...
					<div class="row mb-5 pb-5">
						...
						<div class="col-sm-7" data-aos="fade-up" data-aos-offset="-500">
							...
							<form>
								<div class="row">
									<div class="col-sm-12">
										<a href="event-calendar-org/index.php" class="btn btn-secondary">View Calendar of Events</a>
									</div>
								</div>
							</form>
						</div>
