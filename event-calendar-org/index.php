...
svg { padding: 5px;}
.arrow {cursor: pointer;position: absolute;top: 17%;margin-top: -55px;margin-left: 300px;width: 40px;height: 40px;}
.left {left: 5%;}
...
<div class="container">	
						<button class="arrow left"> <a href ="../org_index.php#events">
