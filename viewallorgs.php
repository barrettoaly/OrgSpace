...
svg { padding: 5px;}
.arrow {cursor: pointer;position: absolute;top: 23%;margin-top: -30px;margin-left: 300px;width: 40px;height: 40px;}
.left {left: 5%;}
                ...
                <?php
                    ...
                    if($check_query){
                        while ($row = mysqli_fetch_array($query))
                        {
                          ...
                          <a href="viewspecificorg.php?id=<?php echo $row['Org_ID'] ?>" >
