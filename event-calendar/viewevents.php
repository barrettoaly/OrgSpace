...
<div role="navigation" class="navbar navbar-default navbar-static-top" style="background: #060297; ">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="nav navbar-nav" href="index_in.php"><img src="..\OrgSpace_LOGO_Final_White.png" style="width:80px; height: 80px;" alt="OrgSpace"></a>
        </div>
        <div class="navbar-collapse collapse" style="background: #060297; ">
          <ul class="nav navbar-nav">
            <li><a style="color:white; font-size:20px" href="index_in.php">Calendar of Events</a></li>
...
<?php
              ...
              {
                if($row['Event_Ticket']==$row['Event_Participants']){
                  echo "This event is not receiving participants already.";
                }
                else{
								echo	"<button class='btn btn-outline-primary register' style='font-size: 15px; width:100%;' name='submit' eID='",$eID,"' oid='",$row['OrgID'],"' eName='",$row['Event_Name'],"'>"."Register"."</button>";
              }
							}
							else{
...
<script>
  $(document).ready(function(){
      ...
      if(response == 1){
      alert('You have already registered. Please wait for confirmation. Thank you!');
          }
          else{
          	alert('Registration Sent! Please wait for confirmation.');
          }
        }
